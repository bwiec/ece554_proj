...
connect_bd_intf_net -intf_net axi_fifo_mm_s_3_AXI_STR_TXD [get_bd_intf_pins axi_fifo_mm_s_3/AXI_STR_TXD] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
  ...
  connect_bd_net -net In4_0_1 [get_bd_ports wdt_irq] [get_bd_pins xlconcat_0/In4]
  ...
  connect_bd_net -net axi_fifo_mm_s_2_interrupt [get_bd_pins axi_fifo_mm_s_2/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axi_fifo_mm_s_3_interrupt [get_bd_pins axi_fifo_mm_s_3/interrupt] [get_bd_pins xlconcat_0/In3]
  ...
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports sample_period_ns] [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins axi_gpio_1/gpio_io_o]
  connect_bd_net -net axi_str_txd_tready_0_1 [get_bd_ports sample_ce] [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tready] [get_bd_pins axi_fifo_mm_s_1/axi_str_txd_tready] [get_bd_pins axi_fifo_mm_s_2/axi_str_txd_tready] [get_bd_pins axi_fifo_mm_s_3/axi_str_txd_tready] [get_bd_pins system_ila_0/SLOT_0_AXIS_tready] [get_bd_pins system_ila_0/SLOT_1_AXIS_tready] [get_bd_pins system_ila_0/SLOT_2_AXIS_tready] [get_bd_pins system_ila_0/SLOT_3_AXIS_tready]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_ports clk_100mhz] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_1/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_2/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_3/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_fifo_mm_s_0/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_fifo_mm_s_1/S_AXI/Mem0] -force
