...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {99990000} \
 ] $clk_100mhz
  set resetn [ create_bd_port -dir O -from 0 -to 0 -type rst resetn ]
  set sample_ce [ create_bd_port -dir I sample_ce ]
  set sample_period_ns [ create_bd_port -dir O -from 31 -to 0 sample_period_ns ]
  set wdt_irq [ create_bd_port -dir I -from 0 -to 0 wdt_irq ]
  set wdt_pet [ create_bd_port -dir O -from 0 -to 0 wdt_pet ]
...
connect_bd_intf_net -intf_net axi_fifo_mm_s_0_AXI_STR_TXD [get_bd_intf_pins axi_fifo_mm_s_0/AXI_STR_TXD] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
connect_bd_intf_net -intf_net axi_fifo_mm_s_1_AXI_STR_TXD [get_bd_intf_pins axi_fifo_mm_s_1/AXI_STR_TXD] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
connect_bd_intf_net -intf_net axi_fifo_mm_s_2_AXI_STR_TXD [get_bd_intf_pins axi_fifo_mm_s_2/AXI_STR_TXD] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
connect_bd_intf_net -intf_net axi_fifo_mm_s_3_AXI_STR_TXD [get_bd_intf_pins axi_fifo_mm_s_3/AXI_STR_TXD] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_fifo_mm_s_1/S_AXI] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M02_AXI [get_bd_intf_pins axi_fifo_mm_s_2/S_AXI] [get_bd_intf_pins axi_interconnect_0/M02_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_fifo_mm_s_3/S_AXI] [get_bd_intf_pins axi_interconnect_0/M03_AXI]
  ...
  connect_bd_net -net In4_0_1 [get_bd_ports wdt_irq] [get_bd_pins system_ila_0/probe7] [get_bd_pins xlconcat_0/In4]
  connect_bd_net -net axi_fifo_mm_s_0_interrupt [get_bd_pins axi_fifo_mm_s_0/interrupt] [get_bd_pins system_ila_0/probe3] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_fifo_mm_s_1_interrupt [get_bd_pins axi_fifo_mm_s_1/interrupt] [get_bd_pins system_ila_0/probe4] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_fifo_mm_s_2_interrupt [get_bd_pins axi_fifo_mm_s_2/interrupt] [get_bd_pins system_ila_0/probe5] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axi_fifo_mm_s_3_interrupt [get_bd_pins axi_fifo_mm_s_3/interrupt] [get_bd_pins system_ila_0/probe6] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_ports sample_period_ns] [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins system_ila_0/probe2]
  connect_bd_net -net axi_gpio_2_gpio_io_o [get_bd_pins axi_gpio_2/gpio_io_o] [get_bd_pins xlslice_1/Din]
  connect_bd_net -net axi_str_txd_tready_0_1 [get_bd_ports sample_ce] [get_bd_pins axi_fifo_mm_s_0/axi_str_txd_tready] [get_bd_pins axi_fifo_mm_s_1/axi_str_txd_tready] [get_bd_pins axi_fifo_mm_s_2/axi_str_txd_tready] [get_bd_pins axi_fifo_mm_s_3/axi_str_txd_tready] [get_bd_pins system_ila_0/SLOT_0_AXIS_tready] [get_bd_pins system_ila_0/SLOT_1_AXIS_tready] [get_bd_pins system_ila_0/SLOT_2_AXIS_tready] [get_bd_pins system_ila_0/SLOT_3_AXIS_tready] [get_bd_pins system_ila_0/probe8]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports clk_100mhz] [get_bd_pins axi_fifo_mm_s_0/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_1/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_2/s_axi_aclk] [get_bd_pins axi_fifo_mm_s_3/s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_interconnect_0/M06_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn1 [get_bd_pins axi_fifo_mm_s_0/s_axi_aresetn] [get_bd_pins axi_fifo_mm_s_1/s_axi_aresetn] [get_bd_pins axi_fifo_mm_s_2/s_axi_aresetn] [get_bd_pins axi_fifo_mm_s_3/s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net proc_sys_reset_1_peripheral_aresetn [get_bd_ports resetn] [get_bd_pins proc_sys_reset_1/peripheral_aresetn] [get_bd_pins system_ila_0/probe0]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net xlslice_0_Dout [get_bd_ports wdt_pet] [get_bd_pins system_ila_0/probe1] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins proc_sys_reset_1/aux_reset_in] [get_bd_pins xlslice_1/Dout]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_fifo_mm_s_1/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_fifo_mm_s_2/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_fifo_mm_s_3/S_AXI/Mem0] -force
